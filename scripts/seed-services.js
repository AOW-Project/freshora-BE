  ...
  // 2. DRY CLEANING SERVICES
  {
    ...
    items: {
      ...
      household: [
        ...
        {
          id: "h2",
          name: "Duvet Cover (Single/Double)",
          price: 10,
          description: "Single/Double",
        },
        {
          id: "h3",
          name: "Blanket (Single/Double)",
          price: 22,
          description: "Single/Double",
        },
        {
          id: "h4",
          name: "Bed Spread (Single/Double)",
          price: 20,
          description: "Single/Double",
        },
        {
        ...
        {
          id: "h13",
          name: "Table Cloth/Table Napkins",
          price: 8,
          description: "Table Cloth/Napkins",
        },
  ...
  // 4. SHOE & BAG SPA
  {
    ...
    items: {
      "shoe-cleaning": [
        ...
        {
          id: "s2",
          name: "Formal Shoes (Leather)",
          price: 90,
          description: "Specialized leather care",
        },
        {
          id: "s3",
        ...
        {
          id: "s8",
          name: "Designer Sneakers (Leather)",
          price: 130,
          description: "Specialized leather care",
        },
        {
        ...
        {
          id: "s11",
          name: "Sandals & Flip Flops (Leather)",
          price: 70,
          description: "Specialized leather care",
        },
        {
        ...
        {
          id: "s16",
          name: "Designer Formal Shoes",
          price: 110,
          description: "Standard cleaning",
        },
        {
          id: "s17",
          name: "Designer Formal Shoes (Leather)",
          price: 120,
          description: "Specialized leather care",
        },
        {
  ...
  // 10. STEAM PRESSING SERVICES
  {
    ...
    items: {
      men: [
        ...
        { id: "msp4", name: "Ghatra", price: 10, description: "Headwear" },
        { id: "msp5", name: "Lungi", price: 8, description: "Casual wear" },
        { id: "msp6", name: "Shorts", price: 8, description: "Casual shorts" },
        { id: "msp7", name: "Cap/Tie", price: 7, description: "Caps and ties" },
        {
          id: "msp8",
          name: "Jacket/Coat",
          price: 20,
      ...
      household: [
        ...
        { id: "h4", name: "Pillow Case", price: 2, description: "" },
        { id: "h5", name: "Cushion Cover", price: 3, description: "" },
        {
          id: "h6",
          name: "Table Cloth/Table Napkins",
          price: 5,
        ...
        { id: "h7", name: "Wedding Dress Normal", price: 30, description: "" },
        {
          id: "h8",
          name: "Curtains (Per Sq meter)",
          price: 10,
